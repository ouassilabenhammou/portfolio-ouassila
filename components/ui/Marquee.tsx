  ...
  return (
    ...
    >
      <FastMarquee
        ...
        className={`${anton.className} h-full min-h-0 touch-pan-y overflow-hidden bg-(--color-primary) uppercase [scrollbar-width:none] [&::-webkit-scrollbar]:hidden [&_.rfm-marquee]:flex [&_.rfm-marquee]:items-center `}
      >
